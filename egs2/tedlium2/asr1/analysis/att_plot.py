...
ax.set_xticklabels([x for x in range(att_w1.shape[1]) if x % 20 == 0], rotation=0, fontsize=12)
# ax.set_yticklabels([x for x in range(1, 10, 1)], rotation=0, fontsize=12)
ax.set_yticklabels([x for x in range(9, 0, -1)], rotation=0, fontsize=12)
...
ax.set_xticklabels([x for x in range(att_w2.shape[1]) if x % 20 == 0], rotation=0, fontsize=12)
# ax.set_yticklabels([x for x in range(10, 19, 1)], rotation=0, fontsize=12)
ax.set_yticklabels([x for x in range(18, 9, -1)], rotation=0, fontsize=12)
