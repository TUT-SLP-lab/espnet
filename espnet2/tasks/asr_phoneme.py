...
class ASRPhonemeTask(AbsTask):
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModelWithPhoneme:
        ...
        if isinstance(args.token_list, str):
            _token_list, _phone_token_list = args.token_list, args.phone_token_list, 
            with open(_token_list, encoding="utf-8") as f:
        ...
        logging.info(f"Phoneme's ocabulary size: {phone_vocab_size }")
